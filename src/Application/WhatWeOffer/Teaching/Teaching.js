...
import Header from './assets/images/BannerHeader.png';
import TeachingCourse from './TeachingCourse';
// import CardTeaching from "./CardTeaching";
import Footer from '../../Footer/Footer';
// import TransformingEducation from "./TransformingEducation";
...
export default function Teaching() {
    return (
        <div className="onload">
            <Nav SrcImg={Header} Display="What We Offer / Teaching" active="what-we-offer/teaching" />
            {/* Pitchfork Kickstarter Taxidermy */}
            <div className="grid lg:grid-cols-3 lge:grid-cols-3 sm:grid-cols-1 md:grid-cols-1 mdsm:grid-cols-1 py-12 sm:px-9 px-14">
