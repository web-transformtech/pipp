  ...
  return (
    <>
      ...
      <div
        className={`${
          mobilenav
            ? `absolute bg-[#000000af] h-full transform transition-all ease-in-out duration-500`
            : ""
        }`}
      >
        <div className="relative">
          ...
          > */}
                ...
                <li className="px-3 relative group flex ">
                  ...
                  >
                    <Link
                      to="/what-we-offer/teaching"
                      className={`text-center block py-2.5 px-7 hover:bg-secondary`}
                    >
                      <li
                        className={`${
                          props.active === "what-we-offer/teaching"
                            ? "active"
                            : "hover-underline-animation"
                        } `}
                      >
                    ...
                    {/* <br /> */}
                    <Link
                      to="/what-we-offer/research"
                      className={`text-center block py-2.5 px-5 hover:bg-secondary`}
                    >
                      <li
                        className={`${
                    ...
                    {/* <br /> */}
                    <Link
                      to="/what-we-offer/advocacy"
                      className={`text-center block py-2.5 px-5 hover:bg-secondary`}
                    >
                      <li
                        className={`${
                          props.active === "advocacy"
                            ? "active"
                            : "hover-underline-animation"
                        }`}
                      >
                    ...
                    <Link
                      to="/what-we-offer/practice"
                      className={`text-center block py-2.5 px-5 hover:bg-secondary`}
                    >
                      <li
                        className={`${
                          props.active === "practice"
                            ? "active"
                            : "hover-underline-animation"
                        }`}
                      >
                ...
                <Link to="/news-announcements" className={`block px-3`}>
                  <li
                    className={`${
                      props.active === "news-announcements"
                        ? "active"
                        : "hover-underline-animation"
                    }`}
                  >
