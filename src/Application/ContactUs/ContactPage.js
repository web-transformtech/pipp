      ...
      <div className="pb-24 pt-16 sm:pb-32 sm:pt-24 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2">
        <div className="px-6 lg:px-8">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <h2 className="text-[26px] font-bold tracking-tight text-primary">
              Let's work together
            </h2>
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <div className="grid grid-cols-2">
                  <div className="">
                    <label
                      htmlFor="first-name"
                      className="block text-sm font-semibold leading-6 text-primary font-Lato"
                    >
                      First name
                    </label>
                ...
                <div className="sm:col-span-2">
                  <div className="flex justify-between text-sm leading-6">
                    <label
                      htmlFor="phone"
                      className="block font-semibold text-primary font-Lato"
                    >
                      Phone
                    </label>
