                    ...
                    <div className="col-span-3 py-2">
                      <div>
                        <p className="text-[20px] text-justify font-PoppinsMedium text-secondary-text pb-4">
                          “ I want to let you know that I am very absolutely
                          delighted with the course in every respect. It has
                          been particularly pleasing for me, with an interest in
                          seeing the application and good educational practice
                          to school education. Learn a different approach that
