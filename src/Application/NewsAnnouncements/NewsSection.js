                  ...
                  <div class="py-8 px-4 w-full rounded-md bg-white">
                    <div class="h-full flex items-start cursor-move">
                      <div class="w-12 flex-shrink-0 flex flex-col text-center leading-none">
                        <span class="text-text-secondary pb-2 mb-2 border-b-2 border-gray-200">
                          Jul
                        </span>
                        <span class="font-medium text-lg text-text-secondary leading-none">
                          18
                        </span>
                      </div>
                      <div class="flex-grow pl-6">
                        <h2 class="tracking-widest text-xs font-PoppinsBold text-primary mb-1">
                          CATEGORY
                        </h2>
                        <h1 class="text-xl text-text font-LatoBold mb-3">
                          Neptune
                        </h1>
